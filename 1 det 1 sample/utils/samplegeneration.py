...
def generate_sample(noise_random_seed,
                    static_arguments,
                    event_tuple,
    ...
    Returns:
        ...
        'h1_strain'}`), and the `injection_parameters`,
    ...
    if hdf_file_paths is None:
        ...
        noise['H1'] = noise_from_psd(length=noise_length,
                                    delta_t=(1.0 / target_sampling_rate),
                                    psd=psd,
                                    seed=(2 * event_time + noise_random_seed))
        ...
        noise['H1']._epoch = LIGOTimeGPS(start_time)
    ...
    # and add it into the noise to create the strain
        ...
        # injection SNR
        strain['H1'] = noise['H1'].add_into(scale_factor *
                                          detector_signals['H1'])
    ...
    strain['H1'] = \
        strain['H1'].whiten(segment_duration=segment_duration,
    ...
    if bandpass_lower != 0:
        strain['H1'] = strain['H1'].highpass_fir(frequency=bandpass_lower,
                                               remove_corrupted=False,
                                               order=512)
    ...
    if bandpass_upper != target_sampling_rate:
        strain['H1'] = strain['H1'].lowpass_fir(frequency=bandpass_upper,
                                              remove_corrupted=False,
                                              order=512)
    ...
    strain['H1'] = strain['H1'].time_slice(a, b)
    ...
    if waveform_params is not None:
        ...
        detector_signals['H1'] = detector_signals['H1'].time_slice(a, b)
